...
set_driving_cell -lib_cell BUFX2 -library KISTA_SOI_STDLIB_ECSM_TT -pin "Y" [get_ports enable]
set_driving_cell -lib_cell BUFX2 -library KISTA_SOI_STDLIB_ECSM_TT -pin "Y" [get_ports clk]
set_driving_cell -lib_cell BUFX2 -library KISTA_SOI_STDLIB_ECSM_TT -pin "Y" [get_ports reset]
